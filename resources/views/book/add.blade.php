            ...
            <form class="uk-form-horizontal uk-margin-large" method="post">
               ...
               <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-horizontal-text" type="text" placeholder="name" name="book_name">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-horizontal-text" type="text" placeholder="Count" name="count">
                    </div>
                </div>
                <div class="uk-margin">
