...
<div class="uk-container">
  <a href="{{ route('student.add') }}"  class="uk-button uk-button-primary">Add Student</a>
...
{{$user->contact}}
            ...
            <td> <a href="{{ route('student.edit',$user->id) }}"  class="uk-button uk-button-primary">Edit</a> </td>
                        <td> <a href="{{ route('student.delete',$user->id) }}"  class="uk-button uk-button-primary">Delete</a> </td>
     ...
     $.ajax({
                ...
                success : function(result) {
                  ...
                  $("#load").empty();
                   ...
                   html +='<tr><td>'+id+'</td><td>'+name+'</td><td>'+username+'</td><td>'+gender+'</td><td>'+contact+'</td><td> <a href="/student/edit/'+id+'"  class="uk-button uk-button-primary">Edit</a> </td><td> <a href="/student/delete/'+id+'"  class="uk-button uk-button-primary">Delete</a> </td></tr>';
                   }
